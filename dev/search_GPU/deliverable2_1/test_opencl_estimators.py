...
if __name__ == "__main__":
    ...
    parser.add_argument("--old", action="store_true", help="Use Marios old code")
    parser.add_argument("--cpu", action="store_false", help="Run code on CPU")
    parser.add_argument("--padding", action="store_true", help="Pad pointset")
    ...
    print(
        "pointset shape % n_chunks: {} (chunkkength: {})\n".format(
