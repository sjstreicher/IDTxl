...
def test_average_pid_source_copy():
    ...
    assert np.isclose(
        0.5849625007211562, est_goettingen["avg"][((1,),)][2], atol=1.0e-7
    ), "Unique information 1 is not 1 for SxPID estimator ({0}).".format(
        est_goettingen["avg"][((1,),)][2]
    )
    assert np.isclose(
        -0.4150374992788438, est_goettingen["avg"][((2,),)][2], atol=1.0e-7
...
def _estimate(T):
    ...
    print("Uni s1               {0:.8f}".format(est_goettingen["avg"][((1,),)][2]))
    print("Uni s2               {0:.8f}".format(est_goettingen["avg"][((2,),)][2]))
    print(
        "Shared s1_s2         {0:.8f}".format(
            est_goettingen["avg"][
                (
                    (1,),
                    (2,),
...
def test_average_pid_three_hash():
    ...
    print(
        "Shared of (Synergy s1_s2, Synergy s1_s3)                 {0:.8f}".format(
            est_goettingen["avg"][
                (
                    (
                        1,
    ...
    print(
        "Shared of (Synergy s1_s2, Synergy s2_s3)                 {0:.8f}".format(
            est_goettingen["avg"][
                (
                    (
                        1,
    ...
    print(
        "Shared of (Synergy s1_s3, Synergy s2_s3)                 {0:.8f}".format(
            est_goettingen["avg"][
                (
                    (
                        1,
    ...
    print(
        "Shared of (Synergy s1_s2, Synergy s1_s3, Synergy s2_s3)  {0:.8f}".format(
            est_goettingen["avg"][
                (
                    (
                        1,
    ...
    print(
        "Shared of (s1, Synergy s2_s3)                            {0:.8f}".format(
            est_goettingen["avg"][
                (
                    (1,),
                    (2, 3),
    ...
    print(
        "Shared of (s2, Synergy s1_s3)                            {0:.8f}".format(
            est_goettingen["avg"][
                (
                    (2,),
                    (1, 3),
    ...
    print(
        "Shared of (s3, Synergy s1_s2)                            {0:.8f}".format(
            est_goettingen["avg"][
                (
                    (3,),
                    (1, 2),
    ...
    assert np.isclose(
        0.24511249783653177, est_goettingen["avg"][((1, 2, 3),)][2]
