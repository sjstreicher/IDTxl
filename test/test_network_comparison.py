...
def test_calculate_cmi_all_links():
    ...
    res_0 = pickle.load(
        open(os.path.join(os.path.dirname(__file__), "data/mute_results_0.p"), "rb")
    )
